...
function in_words(number) {
  ...
  var tenthsDifferent = ['sepuluh','sebelas','dua belas','tiga belas','empat belas','lima belas','enam belas','tujuh belas','delapan belas','sembilan belas']
  ...
  var posfix = [null,'ribu','juta','milyar','triliun','quadrillion','quintillion','sextillion'];
  if (digitsGroupLen > 1) {
...
console.log(in_words(509))
console.log(in_words(5090))
console.log(in_words(50900))
console.log(in_words(509000))
console.log(in_words(5090000))
